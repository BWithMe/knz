...
function getConnection() {
	...
	global $db_knz_db_Url, $db_knz_db_User, $db_knz_db_Pass, $db_knz_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_knz_db_Url.";dbname=".$db_knz_db_DbName, $db_knz_db_User, $db_knz_db_Pass);
